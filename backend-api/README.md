...
## About Laravel - backend for KDG Accounting Software
...
1. **Clone the GitHub repository**
   ```sh
   git clone https://github.com/KDGS-Dart/KDGAccounting.git
   
   Navigate to the backend-laravel and continue with the next steps
...
6. **Run migrations** - this will be changed later since we are running in slqsrv
